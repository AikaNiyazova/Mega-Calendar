...
public class PositionMapperImpl implements PositionMapper {
    ...
    public PositionDto toDto(Position entity) {
        ...
        positionDto.id( entity.getId() );
        positionDto.department( departmentToDepartmentDto( entity.getDepartment() ) );
        positionDto.positionName( entity.getPositionName() );
        positionDto.isDeleted( entity.getIsDeleted() );
    ...
    public Position toEntity(PositionDto dto) {
        ...
        position.department( departmentDtoToDepartment( dto.getDepartment() ) );
        position.positionName( dto.getPositionName() );
        position.isDeleted( dto.getIsDeleted() );
